...
<head>
    ...
    <title>Dashboard - {{ config('app.name', 'Laravel') }} Admin Dashboard</title>

    <link rel="shortcut icon" href="{{ asset('assets/admin/assets/compiled/svg/favicon.svg') }}" type="image/x-icon" />
    <link rel="stylesheet" href="{{ asset('assets/admin/assets/compiled/css/layout-rtl-backup.css') }}" />
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ url('/admin') }}"><img
                                    src="{{ asset('assets/admin/assets/compiled/svg/logo.svg') }}" alt="Logo"
                                    srcset="" /></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item ">
                            <a href="{{ url('/admin/jenis') }}" class="sidebar-link">
                        ...
                        <li class="sidebar-item ">
                            <a href="{{ url('/admin/wisata') }}" class="sidebar-link">
