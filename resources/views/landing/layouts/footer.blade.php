...
<section class="section-footer">
    ...
    <div class="footer-bottom">
        <p>{{ config('app.name', 'Laravel') }} - Created With <span class="ion-heart red"></span> to create a Lovable
            Website</p>
    </div>
</section>
...
<script type="text/javascript" src="{{ asset('assets/landing/js/swipe.js') }}"></script>
</body>
